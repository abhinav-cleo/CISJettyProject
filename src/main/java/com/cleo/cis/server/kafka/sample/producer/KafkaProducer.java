...
public class KafkaProducer {
  ...
  public void initialize() {
    ...
    producerProps.put("metadata.broker.list", "ec2-35-164-171-235.us-west-2.compute.amazonaws.com:9092");
    producerProps.put("advertised.host.name", "ec2-35-164-171-235.us-west-2.compute.amazonaws.com:9092");
    producerProps.put("serializer.class", "kafka.serializer.StringEncoder");
//    producerProps.put("partitioner.class", "com.panda.kafka.training.PandaKafkaPartitioner");
